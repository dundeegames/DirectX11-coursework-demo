...
UberShader::UberShader(ID3D11Device* device, HWND hwnd) : BaseShader(device, hwnd),
...
void UberShader::InitShader(WCHAR* vsFilename, WCHAR* psFilename)
{
...
void UberShader::InitShader(WCHAR* vsFilename, WCHAR* hsFilename, WCHAR* dsFilename, WCHAR* psFilename)
{
...
void UberShader::setLights(std::vector<Light*>& lights)
{
#ifdef _DEBUG
...
void UberShader::addLight(Light* light)
{
#ifdef _DEBUG
...
void UberShader::setView(ID3D11DeviceContext* deviceContext,
...
void UberShader::Render(ID3D11DeviceContext* deviceContext, int indexCount)
{

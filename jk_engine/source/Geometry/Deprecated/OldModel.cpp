...
OldModel::OldModel(ID3D11Device* device, WCHAR* textureFilename, WCHAR* filename)
{
  // Load model data
  LoadModel(filename);
...
void OldModel::InitBuffers(ID3D11Device* device)
{
  VertexType* vertices;
...
void OldModel::LoadModel(WCHAR* filename)
{
  // Process model file
